...
MGD <- subset(data, ident = c("0"))#, subset = (Cond == "CTR" | Cond == "GEL"))
...
write.csv(full.results.df, file = "C:/Users/markenbe/OneDrive - Indiana University/7- R/Data/Pancreatic/Output/dim12_res0.8_cl0_CTRGEL_MGD_DESeq2.csv")
...
VOLC(data, "GEL", "CTR", group = "Cond", subset = "0", tiff = F)