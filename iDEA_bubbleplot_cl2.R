...
res <- fread(file = "C:/Users/.../Output/dim12_res0.8_cl2_CTRGEL_MGD_DESeq2.csv")
...
write.csv(idea@gsea, "C:/Users/.../Output/iDEA_cl2_GEL-CTR(r).csv")
...
plotdata<- fread(paste0(Path, "/Output/iDEA_cl2_GEL-CTR(r).csv"))
...
write.csv(bp.data, paste0(Path, "/Output/iDEA_cl2_GEL-CTR(r)_iDEAup.full.csv"))
...
postscript(paste0(Path, "/Output/iDEA-bubble_cl2_GEL-CTR(r).eps"))
bp
dev.off()

ggsave(filename = paste0(Path, "/Output/iDEA-bubble_cl2_GEL-CTR(r).eps"),
       plot = bp,
       width = 20,
       height = 20/1.66667,
       units = "in",
